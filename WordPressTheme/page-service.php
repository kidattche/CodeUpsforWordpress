      ...
      <div class="p-page-service__items">
        ...
        <div class="p-page-service__item">
          <div class="p-page-service__image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/service_1.jpg" alt="Webサイト制作の画像">
          </div>
        ...
        <div class="p-page-service__item">
          <div class="p-page-service__image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/service_2.jpg" alt="Webサイト運用の画像">
          </div>
          <div class="p-page-service__text-block">
        ...
        <div class="p-page-service__item">
          <div class="p-page-service__image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/service_3.jpg" alt="アプリ開発の画像">
          </div>
          <div class="p-page-service__text-block">
